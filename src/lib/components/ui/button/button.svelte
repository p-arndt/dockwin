	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				success: "bg-chart-2/10 hover:bg-chart-2/20 focus-visible:ring-chart-2/20 dark:focus-visible:ring-chart-2/40 dark:bg-chart-2/20 text-chart-2 focus-visible:border-chart-2/40 dark:hover:bg-chart-2/30",
